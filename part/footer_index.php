<footer class="page-footer font-small unique-color-dark pt-4 col">
    <div>
        <a href="#_top" target="_top"> <img src="imagenes/arrow.png" alt="icono flecha arriba" width="52" height="52"
                class="icn">
        </a>
        <div class="container line">
            <ul class="list-unstyled list-inline text-center py-2 futl">
                ...
                <li class="list-inline-item">
                    <a href="https://www.instagram.com/teckelsbakery/"><img src="imagenes/h.png" alt="Logo Instagram"
                            width="52" height="52" class="ic"></a>
                </li>
                <li class="list-inline-item">
